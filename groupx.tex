...
\noindent
where \cword{N} is the count of E, C(E) pairs, and \cword{INT} specifies the
...
needed can be used for ``\cword{card8b}'', as long as the terminating
slash is included.
...
\item[\cword{error in f6lab***illegal lang.}] ~\par
  The value of \cword{lang} must be in the range 11-15 for tabulated
